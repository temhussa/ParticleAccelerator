1) Main file which needs to be compiled in order for the simulation to be run is TestParticle.java

2) Current configuration is a cyclotron accelerating a beam of protons non relativistically
